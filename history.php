<?php
	...
	{
		$count = get_query_value (mysql_query ("SELECT MAX(*) FROM " . SQL_TABLE . " WHERE channel = \"" . $chanEsc . "\""));
		$query = "SELECT * FROM " . SQL_TABLE . " WHERE id > ($count - " . $_GET["last"] . ")". $botblocksql. " && channel = \"" . $chanEsc . "\" LIMIT 0,10000";
	}
	else
	{
