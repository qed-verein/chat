<?php
	...
	$post["message"]=str_replace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse"),array("darij","darij","darijs"," spam","freu","freu","pizza"),$post["message"]);
	
	
	$post['name']=strpos($post['name'],0,20);
	/*if($post["name"]=="   Toddy")
		$post["message"]="";*/
