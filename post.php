<?php
	...
	if((substr($post["ip"],0,7)=="129.187")or(substr($post["ip"],0,7)=="138.246"))
		exit();
		
	$post["message"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","drecksau","===D","jerk off","wichs"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," Fermatbeweiser","===#","by honest","zerstÃ¶r"),$post["message"]);
	$post["name"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","drecksau","===D","jerk off","wichs"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," Fermatbeweiser","===#","by honest","zerstÃ¶r"),$post["name"]);	
