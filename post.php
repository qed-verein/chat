<?php
	...
	$post["message"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","idiot","drecksau","===D","jerk off","wichs"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," lieber mensch"," Fermatbeweiser","===#","by honest","zerstÃ¶r"),$post["message"]);
	$post["name"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","idiot","drecksau","===D","jerk off","wichs"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," lieber mensch"," Fermatbeweiser","===#","by honest","zerstÃ¶r"),$post["name"]);	
