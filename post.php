<?php
	...
	$post["message"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","idiot","drecksau","===D","jerk off","wichs"),array("darij","darij","darijs"," lieber mensch","freu","freu","pizza"," lieber mensch"," lieber mensch","===#","by honest","zerstÃ¶r"),$post["message"]);
		$post["name"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","idiot","drecksau","===D","jerk off","wichs"),array("darij","darij","darijs"," lieber mensch","freu","freu","pizza"," lieber mensch"," lieber mensch","===#","by honest","zerstÃ¶r"),$post["name"]);	
