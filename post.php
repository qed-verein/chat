...
//	if((substr($post["ip"],0,7)=="129.187")or(substr($post["ip"],0,7)=="138.246")or(substr($post["ip"],0,7)=="193.200")or(substr($post["ip"],0,7)=="200.140")or(substr($post["ip"],0,6)=="194.95")or(substr($post["ip"],0,8)=="141.84.2")or(substr($post["ip"],0,7)=="193.200")or(substr($post["ip"],0,5)=="78.46"))
	...
	$post["message"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","drecksau","===D","jerk off","wichs","soggy"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," Fermatbeweiser","===#","be honest","zerstÃ¶r","tasty"),$post["message"]);
	$post["name"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","drecksau","===D","jerk off","wichs","soggy"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," Fermatbeweiser","===#","be honest","zerstÃ¶r","tasty"),$post["name"]);	
