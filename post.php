...
//	$post["message"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","drecksau","===D","jerk off","wichs","soggy biscuit"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," Fermatbeweiser","===#","be honest","zerstÃ¶r","tasty human"),$post["message"]);
//	$post["name"]=str_ireplace(array("penis","schwanz","schwÃ¤nze"," arsch","fuck","fick","pisse","drecksau","===D","jerk off","wichs","soggy,biscuit"),array("darij","darij","darijs"," kreisquadrierer","freu","freu","pizza"," Fermatbeweiser","===#","be honest","zerstÃ¶r","tasty human"),$post["name"]);	
